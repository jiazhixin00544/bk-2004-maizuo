<template>
    <div class="center-view">
        ...
        >
            ...
            <div class="nick-name" @click="goLogin" v-if="!userInfo.username">
                立即登录
            </div>
            <div class="nick-name" v-if="userInfo.username">
        ...
        >
            ...
            <span class="value"
                ><span class="price-decimal price-fmt"
                    ><i>￥</i>
                    <span class="interge" v-if="!userInfo.username" style="font-size: 15px;">0.00</span>
                    <span class="interge" v-if="userInfo.username" style="font-size: 15px;">99999.99</span>
...
export default {
    ...
    created(){
        ...
        if (jwt) {
            // 发请求
            this.$http
                .get("http://127.0.0.1:2004/get_user_info")
